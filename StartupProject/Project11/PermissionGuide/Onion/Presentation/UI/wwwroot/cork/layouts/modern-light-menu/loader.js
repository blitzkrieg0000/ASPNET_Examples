window.addEventListener("load", function(){
    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '/cork/src/assets/img/logo.gif',
                    lightLogo: '/cork/src/assets/img/logo2.gif'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/logo.gif')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/logo2.gif')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (getParseObject.settings.layout.boxed) {
            ...
            if (document.body.getAttribute('layout') !== 'full-width') {
                ...
                if (document.querySelector('.header-container')) {
                    document.querySelector('.header-container').classList.add('container-l');
                }
                if (document.querySelector('.middle-content')) {
                    document.querySelector('.middle-content').classList.add('container-l');
                }
            } else {
                document.body.classList.remove('layout-boxed');
                if (document.querySelector('.header-container')) {
                    document.querySelector('.header-container').classList.remove('container-l');
                }
                if (document.querySelector('.middle-content')) {
                    document.querySelector('.middle-content').classList.remove('container-l');
                }
            }
