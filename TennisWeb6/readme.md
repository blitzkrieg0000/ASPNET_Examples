...
## SCAFFOLD 
```
	dotnet ef dbcontext scaffold "Host=localhost;Database=tenis;Username=tenis;Password=2sfcNavA89A294V4" Npgsql.EntityFrameworkCore.PostgreSQL -o ../Domains/Scaffold/ --project UI/UI.csproj
```
